...
<body>
    ...
    <main>
        ...
        <div class="grid">
            <div class="grid-item">
                <a href="/buku/create/" class="button-link">Add Books</a>
            </div>
            <div class="grid-item">
                <button onclick="window.location.href='/buku/list_buku/'" class="button-link">Edit Delete Books</button>
            </div>
            <div class="grid-item">
                <a href="<?= base_url('admin/history') ?>" class="button-link">History Pinjam</a>
            </div>
        </div>
